package com.example.alicenguyen.contextlock.andrognito.pinlockview;
...
public class PinLockView extends RecyclerView{
    ...
    //private  IndicatorDots mIndicatorDots = new IndicatorDots;
        ...
        public void onNumberClicked(int keyValue) {
            if (mPin.length() < getPinLength()) {
                ...
                if (isIndicatorDotsAttached()) {
                    ...
                    //mIndicatorDots.upDot(mPin.length());
                }
    ...
    public void enableLayoutShuffling() {
        ...
        //this.mCustomKeySet = ShuffleArrayUtils.shufflePub(DEFAULT_KEY_SET);
        if (mAdapter != null) {
    ...
    public void resetPinLockView() {
        ...
        if (mIndicatorDots != null) {
            mIndicatorDots.updateDot(mPin.length());
            //mIndicatorDots.upDot(minPin.length);
        }
    }
